...
export const translations = {
  sv: {
    ...
    mapUnavailable: "Kartan kräver Google Maps API-nyckel. Listan och filtren fungerar ändå.",
    favorites: "Favoriter",
  ...
  en: {
    ...
    mapUnavailable: "Map needs a Google Maps API key. The list and filters still work.",
    favorites: "Favorites",
