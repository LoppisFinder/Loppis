...
| Web CORS error | Add your web origin to API `CORS_ORIGINS` on Render (comma-separated), e.g. `http://localhost:3000,https://your-app.azurewebsites.net`. Do **not** use `*` alone — redeploy API after changing |
